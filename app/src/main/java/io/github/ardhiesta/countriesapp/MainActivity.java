    ...
    private ArrayList<Country> isiDataCountry(JSONArray countryJsonArray) {
        ...
        try {
            ...
            for (int i = 0; i < countryJsonArray.length(); i++) {
                ...
                country.setName(countryJsonObject.getString("name"));
                country.setCapital(countryJsonObject.getString("capital"));
                country.setFlag("http://www.countryflags.io/"
                        + countryJsonObject.getString("alpha2Code") + "/flat/64.png");
